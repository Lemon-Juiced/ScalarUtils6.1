...
public class ScalarUtilsItems {
    ...
    /* Ignition Suite */
    public static final DeferredItem<IgnitionWeaponItem> IGNITION_SWORD = ITEMS.registerItem("ignition_sword", p -> new IgnitionWeaponItem(p.sword(ScalarToolMaterials.RED_DIAMOND, 3.0F, -2.4F)));
    public static final DeferredItem<IgnitionAxeItem> IGNITION_AXE = ITEMS.registerItem("ignition_axe", p -> new IgnitionAxeItem(ScalarToolMaterials.RED_DIAMOND, 5.0F, -3.0F, p));
    public static final DeferredItem<IgnitionWeaponItem> IGNITION_SPEAR = ITEMS.registerItem("ignition_spear", p -> new IgnitionWeaponItem(p.spear(ScalarToolMaterials.RED_DIAMOND, 1.15F, 1.2F, 0.4F, 2.5F, 7.0F, 5.5F, 5.1F, 8.75F, 4.6F)));
